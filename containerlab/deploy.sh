...
echo ""
echo "Access nodes:"
echo "  docker exec -it clab-basic-lab-hs1 bash"
echo "  docker exec -it clab-basic-lab-rt1 bash"
echo "  docker exec -it clab-basic-lab-hs2 bash"

echo ""
echo "Test connectivity(hs1 -> hs2):"
echo "  docker exec clab-basic-lab-hs1 ping -c 3 10.0.0.2"
echo "  docker exec clab-basic-lab-hs1 ping -6 -c 3 fc00::2"
echo ""
echo ""
echo "Test connectivity(hs2 -> hs1):"
echo "  docker exec clab-basic-lab-hs1 ping -c 3 10.0.0.1"
echo "  docker exec clab-basic-lab-hs1 ping -6 -c 3 fc00::1"
echo ""
