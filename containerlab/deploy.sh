...
echo "  docker exec clab-basic-lab-hs1 ping  -c 3 10.0.1.1"
echo "  docker exec clab-basic-lab-hs1 ping6 -c 3 fc00:1::1"

echo "Test connectivity (hs2 -> hs1):"
echo "  docker exec clab-basic-lab-hs2 ping  -c 3 10.0.0.1"
echo "  docker exec clab-basic-lab-hs2 ping6 -c 3 fc00::1"
echo ""
